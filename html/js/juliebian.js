(function(){
  ...
  $.ajax({
    type:"get",
    url:"../../php/code/jlb.php/jlb.php?name=hdhg",
    async:true,
  ...
  $.ajax({
  	type:"get",
    url:"../../php/code/jlb.php/jlb.php?name=xcsp&kk=圆座论坛",
    async:true,
    success:function(obj){
...
$.ajax({
	type:"get",
    url:"../../php/code/jlb.php/jlb.php?name=xcsp&kk=无",
    async:true,
    success:function(obj){
    	 var my2 = JSON.parse(obj);
    	//  console.log(my2);
...
/*---------嘉宾图集---------*/
  ...
  $.ajax({
   type:"get",
   url:"../../php/code/jlb.php/jlb.php?name=jbtj",
   async:true,
   success:function(obj){
   	 var my2 = JSON.parse(obj);
   // 	 console.log(my2);
...
$.ajax({
  type:"get",
  url:"../../php/code/jlb.php/jlb.php?name=mtbd",
  asyuc:true,
  success:function(obj){
    var my = JSON.parse(obj);
    // console.log(my);
